...
function draw() {
 ...
 // draw dotted line marker for circuit step 
  ...
  if (measurements1.length > 0) {
    ...
    draw_ket(ctx, measurement_label_pos[0][0] - 3, measurement_label_pos[0][1] - 12, 22, last_measurement1);
    }
  ...
  if (measurements2.length > 0) {
    ...
    if ( measured_state_2) {
      ...
      draw_ket(ctx, measurement_label_pos[1][0] - 3, measurement_label_pos[1][1] - 12, 22, last_measurement2);
    }
